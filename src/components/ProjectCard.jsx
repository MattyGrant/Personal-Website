...
const ProjectCard = (props) => {
  ...
  return (
    <div className=" mx-auto p-4 flex flex-col md:flex-row md:w-full md:justify-around md:my-4 md:text-left lg:p-8">

        <div className="flex-col text-center md:flex-row md:text-left md:w-1/2 md:my-auto md:p-2 lg:p-2 2xl:p-4">
                                    {/* text-primaryBtn */}
        ...
        <hr className="m-auto w-[95%] my-4 h-0.5 bg-primaryText bg-opacity-20 border-none md:hidden"/>
    </div>
