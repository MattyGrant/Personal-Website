...
const Header = () => {
    ...
    return (
        <nav className={`${headerScroll} bg-secondaryBg text-secondaryBtn shadow-mediumOpaque shadow-md text-end top-0 left-0 sticky py-1 px-4 z-20 md:p-2 md:flex md:justify-between lg:p-4 lg:text-lg xl:p-8 xl:mx-auto 2xl:text-xl 2xl:px-32`}>
            
            <div className="flex justify-between m-2">
                <h1 className=" font-medium md:font-semibold"> &lt; MG &#47;&gt;</h1>
            ...
            md:items-center md:w-fit lg:font-normal lg:text-md xl:text-lg xl:font-normal`}>
                ...
                <li className="relative w-min my-1 mx-2 hover:font-semibold">
                    ...
                    after:content-[''] after:bg-secondaryBtn after:h-[1px] after:w-0 after:left-0 after:-bottom-0 after:border-b-[1px] after:border-accent after:rounded-lg after:duration-300" >
                        HOME
                    </Link>
                </li>
                <li className="relative w-max my-1 mx-2 hover:font-semibold">
                ...
                <li className="relative w-min my-1 mx-2 hover:font-semibold">
                    <Link to="footer" spy={true} smooth="true" duration={800} className="hover:cursor-pointer hover:after:w-full after:absolute after:content-[''] after:bg-secondaryBtn after:h-[1px] after:w-0 after:left-0 after:bottom-0 after:border-b-[1px] after:border-accent after:rounded-lg after:duration-300">
                        CONTACT
                    </Link>
                </li>
            </ul>
